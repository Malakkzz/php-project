...
<section class="home" id="home">
    ...
    <div class="content">
        ...
        <p>specializes in delicious food featuring fresh ingredients and masterful preparation by the <b >Panadora</b> culinary team. Whether you’re ordering a multi-course meal or grabbing a drink and pizza at home, <b >Panadora</b> lively, casual yet upscale atmosphere makes it perfect for dining with friends, family, clients and business associates!</p>
        <a href="signup.php" class="btn">Sign Up</a>
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <h3>tasty burger</h3>
                <p>
                    The best burgers offer a combination of tastes and textures – sweet, sour, salt – with a bit of crunch. The patty is so juicy, the bun soft but sturdy.  A quarter pound flattened piece of meat.
                    </p>
            </div>
        </div>
        <div class="box">
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <p>a rich, sweet, creamy frozen food made from variously flavored cream and milk products churned or stirred to a smooth consistency during the freezing process and often containing gelatin, etc..      </p>
            </div>
        </div>
        <div class="box">
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <h3>tasty sweets</h3>
                <p>Dissert ,such as biscuits, cakes, cookies, custards, gelatins, ice creams, pastries, pies, puddings, macaroons, sweet soups, tarts, and fruit salad. contain cane sugar, palm sugar, brown sugar,etc..</p>
            </div>
        </div>
        <div class="box">
            ...
            <div class="content">
                ...
                <p>Breakfast brought a serene sense of comfort that started the day so well.Four eggs for breakfast, fried in a brushing of olive oil, lightly salted... so perfect.Toast and peanut butter, a glass of oat milk.</p>
            </div>
        </div>
